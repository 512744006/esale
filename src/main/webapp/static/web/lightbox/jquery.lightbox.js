...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			STATIC_URL + 'web/img/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			STATIC_URL + 'web/img/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			STATIC_URL + 'web/img/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			STATIC_URL + 'web/img/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				STATIC_URL + 'web/img/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
			// Configuration related to container image box
			containerBorderSize:	10,			// (integer) If you adjust the padding in the CSS for the container, #lightbox-container-image-box, you will need to update this value
			containerResizeSpeed:	400,		// (integer) Specify the resize duration of container image. These number are miliseconds. 400 is default.
			// Configuration related to texts in caption. For example: Image 2 of 8. You can alter either "Image" and "of" texts.
			txtImage:				'Image',	// (string) Specify text "Image"
			// txtImage:				'img',	// (string) Specify text "Image"
		...
		function _resize_container_image_box(intImageWidth,intImageHeight) {
			...
			if (intWidth > winWidth) { intHeight = winWidth * (intHeight / intWidth );intWidth = winWidth; };
			// Diferences
